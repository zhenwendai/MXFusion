...
from nfw.bnn_aux_full import BNN_AUX
...
if __name__ == '__main__':
    ...
    net = BNN_AUX(model_units, conf['random_dim'], conf['mlp_hidden'], conf['num_samples'], conf['sigma2_trans'], conf['sigma2_rev'], device).to(device)

    # if conf['dataset'] == 'housing':
    #     net.noise_var.data.fill_(np.expm1(np.log(train.var(0)[-1]*0.01)))
